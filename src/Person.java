...
public class Person {
  ...
  public static void main(String[] args) {
    ...
    Person person1 = new Person("Kate", 25);
    // Create another instance of Person with a different name and age and
    // assign it to a different variable
    Person person2 = new Person("Le", 24);
    ...
    // as the argument.
     int firstPersonBirthYear = person1.birthYear(2026);
    // In a separate statement, print the local variable holding the birth year.
    System.out.println(firstName + " spawn in " + firstPersonBirthYear);
    /**
     * Terminology!
     * 
